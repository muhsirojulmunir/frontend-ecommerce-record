...
{{--
    Pembungkus halaman berisi teks panjang (kebijakan, syarat, dsb).
    Gayanya ditulis sebagai CSS biasa supaya tampil benar tanpa perlu
    menjalankan ulang build aset Tailwind.
--}}
...
@once
    @push('styles')
        <style>
            ...
            .halaman-teks h2:first-child { margin-top: 0; }
            .halaman-teks h3 {
                font-size: 14px;
                font-weight: 700;
                color: #374151;
            ...
            .halaman-teks p { margin-bottom: 14px; }
            .halaman-teks strong { color: #374151; font-weight: 700; }
            .halaman-teks a { color: var(--color-primary, #1B3A6B); text-decoration: underline; }
            .halaman-teks ul, .halaman-teks ol {
                margin: 0 0 16px 0;
                padding-left: 22px;
            }
            .halaman-teks ul { list-style: disc; }
            .halaman-teks ol { list-style: decimal; }
            .halaman-teks li { margin-bottom: 7px; }
            ...
            .halaman-teks .penting strong { color: #78350f; }
            ...
            .halaman-teks th, .halaman-teks td {
            ...
            .halaman-teks-tombol { display: flex; flex-wrap: wrap; gap: 10px; }
            .ht-tombol {
                display: inline-flex;
                align-items: center;
                gap: 8px;
            ...
            .ht-tombol-wa { background: #25D366; color: #fff; }
            .ht-tombol-wa:hover { background: #20ba59; }
            .ht-tombol-biasa {
                background: #fff;
                color: var(--color-primary, #1B3A6B);
                border: 1px solid #e5e7eb;
            }
            .ht-tombol-biasa:hover { border-color: var(--color-primary, #1B3A6B); }
        </style>
    @endpush
@endonce
